...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .cost-label { font-size: 14px; opacity: 0.9; margin-bottom: 8px; }
    .cost-value { font-size: 32px; font-weight: 900; }
    .cost-formula { font-size: 13px; opacity: 0.9; margin-top: 8px; }
    .notes-box {
      background: #fef3c7;
...
<body>
  ...
  <div class="cost-box">
    <div class="cost-label">💰 עלות מוסכמת</div>
    <div class="cost-value">${totalCost.toLocaleString("he-IL", { minimumFractionDigits: 2, maximumFractionDigits: 2 })} ₪</div>
    <div class="cost-formula">${quantity.toLocaleString("he-IL")} יחידות × ${costPerUnit.toFixed(2)} ₪</div>
  </div>
  ${notes ? `
  <div class="notes-box">
